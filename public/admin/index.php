...
<div class="container">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="carousel slide" id="carousel-799839">
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carousel-799839">
                    </li>
                    <li data-slide-to="1" data-target="#carousel-799839">
                    </li>
                    <li data-slide-to="2" data-target="#carousel-799839">
                    </li>
                </ol>
                ...
                </div> <a data-slide="prev" href="#carousel-799839" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-799839" class="right carousel-control">›</a>
            </div>
        </div>
    </div>
    <div class="container-fluid">
