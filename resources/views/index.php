...
<div class="container">
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="carousel slide" id="carousel-616040">
                    <ol class="carousel-indicators">
                        <li class="active" data-slide-to="0" data-target="#carousel-616040">
                        </li>
                        <li data-slide-to="1" data-target="#carousel-616040">
                        </li>
                        <li data-slide-to="2" data-target="#carousel-616040">
                        </li>
                    </ol>
